...
- **TRAE**: 推荐使用，配套智能体「知识精灵」[点击复刻](https://s.trae.ai/a/15c750)
...
1. **下载**: 访问 [GitHub发布页面](https://github.com/brucevanfdm/DocuGenius/releases/latest) 下载最新 `.vsix` 文件
...
2. 在 TRAE 中打开项目文件夹
3. 复刻「知识精灵」智能体：[https://s.trae.ai/a/15c750](https://s.trae.ai/a/15c750)
4. 开始智能对话和文档分析
